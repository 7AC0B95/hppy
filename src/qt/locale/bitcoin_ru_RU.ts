...
<context>
    ...
    <message>
        ...
        <translation>Это ваши Happy адреса для отправки платежа. Всегда проверяйте сумму и адрес получателя перед отправкой платежа.</translation>
    </message>
    <message>
        ...
        <translation>Это ваши Happy адреса для получения платежей. Настоятельно рекомендуем использовать новые адреса для получения каждой транзакции.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Ваш кошелек теперь зашифрован. Помните, что шифрование вашего кошелька не может полностью защитить ваши Happyы от кражи вредоносным ПО.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Послать средства на Happy адрес</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Подписывайте сообщения Happy адресами чтобы подтвердить что это написали именно Вы</translation>
    </message>
    <message>
        <source>Verify messages to ensure they were signed with specified Happy addresses</source>
        <translation>Проверяйте сообщения чтобы убедиться что они подписаны конкретными Happy адресами</translation>
    </message>
    <message>
        <source>&amp;File</source>
    ...
    <message>
        ...
        <translation>Открыть Happy: URI или запрос платежа</translation>
    </message>
    <message>
    ...
    <message numerus="yes">
        ...
        <translation><numerusform>%n активное подключение к сети Happy</numerusform><numerusform>%n активных подключения к сети Happy</numerusform><numerusform>%n активных подключений к сети Happy</numerusform><numerusform>%n активных подключений к сети Happy</numerusform></translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Произошла критическая ошибка. Happy больше не может продолжать безопасную работу и будет закрыт.</translation>
    </message>
</context>
<context>
...
<context>
    ...
    <message>
        ...
        <translation>Введенный адрес "%1" не является действительным адресом Happy.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Автоматически открыть порт для Happy-клиента на маршрутизаторе. Работает только если Ваш маршрутизатор поддерживает UPnP, и данная функция включена.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Подключится к сети Happy через SOCKS5 прокси.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Отображаемая информация может быть устаревшей. Ваш бумажник автоматически синхронизируется с сетью Happy после подключения, но этот процесс пока не завершён.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Не удаётся запустить happy: обработчик click-to-pay</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>'happy://' не верный URI. Используйте 'happy:' вместо этого.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Не удалось обработать идентификатор! Это может быть связано с неверным Happy-адресом или неправильными параметрами идентификатора.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Необязательное сообщение для запроса платежа, которое будет показано при открытии запроса. Заметьте: сообщение не будет отправлено вместе с платежом через сеть Happy.</translation>
    </message>
    <message>
...
Примечание: Так как комиссия рассчитывается на основе каждого байта, комиссия  "100 сатошей за КБ " для транзакции размером 500 байт (половина 1 КБ) в конечном счете, приведет к сбору только 50 сатошей.</translation>
    ...
    <message>
        ...
        <translation>Предупреждение: Неверный Happy адрес</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Happy-адрес, на который отправить платёж</translation>
    </message>
    <message>
        <source>Alt+A</source>
    ...
    <message>
        ...
        <translation>Сообщение прикрепленное к happy идентификатору будет сохранено вместе с транзакцией для вашего сведения. Заметьте: сообщение не будет отправлено через сеть Happy.</translation>
    </message>
    <message>
        <source>Pay To:</source>
...
<context>
    ...
    <message>
        ...
        <translation>Happy-адрес, которым подписать сообщение</translation>
    </message>
    <message>
        <source>Choose previously used address</source>
        <translation>Выбрать предыдущий использованный адрес</translation>
    ...
    <message>
        ...
        <translation>Подписать сообщение, чтобы доказать владение Happy-адресом</translation>
    </message>
    <message>
        <source>Sign &amp;Message</source>
        <translation>Подписать &amp;Сообщение</translation>
    ...
    <message>
        ...
        <translation>Happy-адрес, которым было подписано сообщение</translation>
    </message>
    <message>
        <source>Verify the message to ensure it was signed with the specified Happy address</source>
        <translation>Проверить сообщение, чтобы убедиться, что оно было подписано указанным Happy-адресом</translation>
    </message>
    <message>
        <source>Verify &amp;Message</source>
        <translation>Проверить &amp;Сообщение</translation>
