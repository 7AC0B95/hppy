...
1. Clone the Happy Core source code:
...
2.  Build Happy Core:
    ...
    Configure and build the headless Happy Core binaries as well as the GUI (if Qt is found).
...
5.  Installation into user directories (optional):
    ...
    or
        ...
        cd ~/happy/src
        cp happyd /usr/local/bin/
        cp happy-cli /usr/local/bin/
...
Before running, you may create an empty configuration file:
    ...
    mkdir -p "/Users/${USER}/Library/Application Support/Happy"

    touch "/Users/${USER}/Library/Application Support/Happy/happy.conf"

    chmod 600 "/Users/${USER}/Library/Application Support/Happy/happy.conf"

The first time you run happyd, it will start downloading the blockchain. This process could take many hours, or even days on slower than average systems.
