# Support for Output Descriptors in Happy Core

Since Happy Core v0.17, there is support for Output Descriptors. This is a
...
on Happy's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing Happy Core wallets, a convenience function `combo` is
