...
By default, Happy Core allows up to 125 connections to different peers, 8 of
...
limits are tiny. Keep in mind that happy's trustless model works best if you are
